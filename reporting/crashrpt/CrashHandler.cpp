...
#ifdef _DEBUG
    sCrashRptModule.Format(_T("CrashRpt%dsd.dll"), CRASHRPT_VER);
    pszCrashRptModule = sCrashRptModule.GetBuffer(0);
#else
    sCrashRptModule.Format(_T("CrashRpt%ds.dll"), CRASHRPT_VER);
    pszCrashRptModule = sCrashRptModule.GetBuffer(0);
#endif //_DEBUG
#else
#ifdef _DEBUG
...
#ifdef STATIC_VERSION
#ifdef _DEBUG
    sCrashSenderName.Format(_T("CrashSender%dsd.exe"), CRASHRPT_VER);
#else
    sCrashSenderName.Format(_T("CrashSender%ds.exe"), CRASHRPT_VER);
#endif //_DEBUG
#else
#ifdef _DEBUG
